...
public class QuantityMeasurementServiceImpl : IQuantityMeasurementService
{
    ...
    private void SaveOperation(double v1, string u1, double v2, string u2, string operation, double result, int userId)
    {
    ...
    public bool Compare(QuantityDTO q1, QuantityDTO q2, int userId)
    {
        ...
        SaveOperation(q1.Value, q1.Unit, q2.Value, q2.Unit, "COMPARE", result ? 1 : 0, userId);

        return result;
    }

    public QuantityDTO Add(QuantityDTO q1, QuantityDTO q2, int userId)
    {
        double v1 = ConvertToBase(q1.Value, q1.Unit);
        double v2 = ConvertToBase(q2.Value, q2.Unit);
        ...
        SaveOperation(q1.Value, q1.Unit, q2.Value, q2.Unit, "ADD", result, userId);

        return new QuantityDTO(result, q1.Unit);
    }

    public QuantityDTO Subtract(QuantityDTO q1, QuantityDTO q2, int userId)
    {
        double v1 = ConvertToBase(q1.Value, q1.Unit);
        double v2 = ConvertToBase(q2.Value, q2.Unit);
        ...
        SaveOperation(q1.Value, q1.Unit, q2.Value, q2.Unit, "SUBTRACT", result, userId);

        return new QuantityDTO(result, q1.Unit);
    }

    public double Divide(QuantityDTO q1, QuantityDTO q2, int userId)
    {
        double v1 = ConvertToBase(q1.Value, q1.Unit);
        double v2 = ConvertToBase(q2.Value, q2.Unit);
        ...
        SaveOperation(q1.Value, q1.Unit, q2.Value, q2.Unit, "DIVIDE", result, userId);

        return result;
    }


    public QuantityDTO Convert(QuantityDTO input, string targetUnit, int userId)
    {
        ...
        SaveOperation(input.Value, input.Unit, 0, targetUnit, "CONVERT", result, userId);
    ...
    {
        return repository.GetByUserIdOperation(userId, operation);
    }
